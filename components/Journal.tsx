              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3 p-3 bg-neutral-900/50 rounded-lg border border-neutral-800 hover:border-primary-600/30 transition-all duration-300">
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      className="w-full mt-2 bg-neutral-900/50 border border-neutral-700 rounded-lg p-2 focus:outline-none focus:ring-2 focus:ring-primary-500/50 text-sm text-neutral-300"
                      placeholder="Enter prompt suggestion..."
